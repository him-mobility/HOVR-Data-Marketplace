// Deterministic PRNG — mulberry32 (Math.imul based). NEVER an LCG.
// A past LCG (seed*1103515245) overflowed JS integer precision (2^53) and
// collapsed unique coordinates to 741. mulberry32 keeps full 32-bit state.
